...
Then('there are numerical buttons to skip to the {int} previous pages') do |int|
  # Then('there are numerical buttons to skip to the {float} previous pages') do |float|
  pending # Write code here that turns the phrase above into concrete actions
end

Then('there are numerical buttons to skip to the {int} next pages') do |int|
...
Then('the number of pages is displayed') do
  pending # Write code here that turns the phrase above into concrete actions
end
