...
import templateRadioGroupWithLongOptions from './_radio_group-long-options.html.haml';
...
<Preview>
  <Story
    ...
    parameters={{
      docs: { source: { code: templateRadioGroupWithLongOptions.raw } },
    }}
  >
    {(_, options) => translate(templateRadioGroupWithLongOptions, options)}
  </Story>
</Preview>
