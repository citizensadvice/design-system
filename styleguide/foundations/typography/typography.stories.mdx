...
export const externalLinkHTML = `<p>A <a href="http://www.example.com/unvisted" class="cads-hyperlink--external">cads-hyperlink--external</a> link, displayed in a paragraph. </p>`;
