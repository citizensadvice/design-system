...
When you link to a page external to your website add the `.cads-hyperlink--external` class to display an icon after the link. This helps to signals to a user that they are leaving the current website.
