...
Translations are handled using the [Rails i18n API](https://guides.rubyonrails.org/i18n.html).
...
en:
  cads:
    example.name: Citizens Advice
    example.body: Loren ipsum dolar sit
