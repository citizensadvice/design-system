...
The first `h2`, `h3` or `h4` element inside the callout will receive the correct title styles. All subsquent `h2` and `h3` headings inside the callout will receive the natural style for that heading.
