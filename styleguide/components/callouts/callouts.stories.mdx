...
The title should be used as `h3` no matter where they are on the page. If a callout is the first thing on the page under a `h1`, still put it in the backend as an `h3` and the CMS will make sure it displays correctly.
