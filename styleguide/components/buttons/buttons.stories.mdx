...
<img src={buttonIconExample} style={{width: '130px'}} />
...
<img src={nextPreviousExample} style={{width: '130px'}} />
...
Do not use anchor tags with an empty href when you want a button `<a href=”#”>` 