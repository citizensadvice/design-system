...
import templatePrimary from './../../examples/button/primary.html';
import templateSecondary from './../../examples/button/secondary.html';
import templateTertiary from './../../examples/button/tertiary.html';
...
<Preview>
  <Story
    name="Primary"
    parameters={{ docs: { source: { code: templatePrimary } } }}
  >
    {() => templatePrimary}
  </Story>
</Preview>
...
<Preview>
  <Story
    name="Secondary"
    parameters={{ docs: { source: { code: templateSecondary } } }}
  >
    {() => templateSecondary}
  </Story>
</Preview>
...
<Preview>
  <Story
    name="Tertiary"
    parameters={{ docs: { source: { code: templateTertiary } } }}
  >
    {() => templateTertiary}
  </Story>
</Preview>
...
```haml
= render CitizensAdviceComponents::Button.new(variant: :primary, "data-testid": "example") do
  Primary button
```
...
| `**additional_attributes` | Additional attributes are passed to the button                          |
