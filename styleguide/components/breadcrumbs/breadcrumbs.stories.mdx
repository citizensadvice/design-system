...
import templateLongTitles from './_long_titles.html.haml';
...
<Preview>
  <Story
    name="Breadcrumbs (Long Titles)"
    parameters={{ docs: { source: { code: templateLongTitles.raw } } }}
  >
    {(_, options) => translate(templateLongTitles, options)}
  </Story>
</Preview>
