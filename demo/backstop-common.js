module.exports = function backstopCommon(baseUrl) {
  ...
  return {
    ...
    scenarios: [
      ...
      {
        label: 'Components/Footer (with text in column)',
        url: componentUrlFor('footer/with_text_column'),
        misMatchThreshold: 0.4,
      },
      {
      ...
      {
        label: 'Components/Summary List',
        url: componentUrlFor('summary_list/default'),
        viewports: [commonViewports.small, commonViewports.large],
