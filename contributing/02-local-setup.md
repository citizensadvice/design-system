...
Running the project locally requires the following language dependencies to be installed.
...
The design system codebase is made up of different languages and components which all have their own tools for running recipes. To help manage this we provide a `justfile` which allows running recipes via `just` from within any directory. Throughout the guides we'll reference these recipes.
